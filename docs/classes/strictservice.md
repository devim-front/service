...
Коллекция событий строгого сервиса. Все пользовательские
...
* [emit](strictservice.md#markdown-header-protected-emit)
* [off](strictservice.md#markdown-header-off)
* [on](strictservice.md#markdown-header-on)
